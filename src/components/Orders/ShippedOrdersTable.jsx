    ...
    useEffect(() => {
        const fetchOrders = async () => {
            ...
            try {
                ...
                setError("Failed to load shipped orders. Check Firebase connection/permissions.");
            } finally {
                setLoading(false);
            }
        };
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center h-64 bg-white rounded-lg shadow-xl p-8">
                ...
                <p className="ml-4 text-gray-700 font-medium">Loading Shipped Orders...</p>
            </div>
        );
    }
        ...
        <div className="flex-1 p-6 lg:p-8 bg-white min-h-screen">
            <div className="orders-container bg-white rounded-lg shadow-xl p-6 border border-gray-200">
                ...
                <div className="flex justify-between items-center pb-4 border-b border-gray-100">
                    ...
                    <button className="px-4 py-2 text-sm font-semibold bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors shadow-md">
                        Download Manifest
                    </button>
                </div>
                ...
                <div className="mt-4 mb-6 relative">
                    ...
                    <input
                        ...
                        className="w-full sm:w-2/3 md:w-1/2 p-3 pl-10 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm bg-white text-gray-900"
                    />
                </div>
                                    ...
                                    <td colSpan="7" className="p-6 text-center text-gray-500">
                                        ...
                                        <p>
                                            {searchTerm 
                                                ...
                                                : "No shipped orders available in the database."
                                            }
                                        </p>
                                    </td>
                                </tr>
