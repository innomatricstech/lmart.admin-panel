...
import { FiSearch, FiXCircle, FiShoppingBag } from 'react-icons/fi';

// --- Sample Data ---
// Include a status field to filter by.
const initialOrdersData = [
  // Order visible in the "Cancelled" screenshot
  { id: 17, customer: 'Tanish', email: 'tanishkarmann13@gmail.com', phone: '9000444139', address: 'sindagi\nsindagi\nPIN: 588128', items: '1 Items\n3 Layer Ribbon Batches', amount: '13', date: '9/11/2025', status: 'Cancelled' },
  
  // Other orders for context
...
export default function CancelledOrdersTable() {
  ...
  // 1. Filter orders to only include 'Cancelled' status
  const cancelledOrders = initialOrdersData.filter(order => order.status === 'Cancelled');
  ...
  return (
    <div className="flex-1 p-6 lg:p-8 bg-gray-100 min-h-screen">
      <div className="orders-container bg-white rounded-lg shadow-xl p-6">
        ...
        {/* Orders Header: Cancelled Orders */}
        <div className="flex justify-between items-center pb-4 border-b border-gray-100">
          <h2 className="text-xl font-bold text-red-700 flex items-center">
            <FiXCircle className="w-5 h-5 mr-2 text-red-600" /> Cancelled Orders
          </h2>
