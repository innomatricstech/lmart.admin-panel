            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-200">
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center text-sm text-gray-600 mb-6">
                        <FiAlertTriangle className="w-4 h-4 text-red-500 mr-2 flex-shrink-0" />
                        <p>This will permanently remove the article from the database.</p>
                    </div>
                </div>
                ...
                <div className="flex justify-end space-x-3 p-6 bg-gray-50 border-t border-gray-200">
                    <button
                        onClick={onClose}
                        className="px-5 py-2.5 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 active:bg-gray-100 transition-colors duration-150"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={onConfirm}
                        className="px-5 py-2.5 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 active:bg-red-800 transition-colors duration-150 flex items-center"
                    >
...
const ViewNews = () => {
    ...
    const handleDeleteConfirm = async () => {
        ...
        setIsDeleting(true);
        try {
            const docRef = doc(db, "news", newsToDelete.id);
